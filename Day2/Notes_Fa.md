...
سوال ۱:
رگرسیون لجستیک چیست؟
پاسخ: الگوریتمی برای طبقه‌بندی که احتمال وقوع یک رویداد را پیش‌بینی می‌کند.

سوال ۲:
K-Means Clustering برای چه کاربردهایی مناسب است؟
پاسخ: گروه‌بندی مشتریان، تحلیل تصاویر، و شناسایی الگوهای داده.

سوال ۳:
Overfitting چیست؟
پاسخ: زمانی که مدل به داده‌های آموزشی بیش از حد وابسته است و روی داده‌های جدید عملکرد ضعیفی دارد.

سوال ۴:
Cross-Validation چیست؟
پاسخ: تکنیکی برای ارزیابی مدل با تقسیم داده‌ها به چندین بخش (Folds).
